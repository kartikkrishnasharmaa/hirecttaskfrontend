    ...
    <>
      <form className='m-auto my-16 max-w-[500px] p-8 bg-white border-2 shadow-md rounded-md'>
        {loading ? (
          ...
          <>
            <h2 className='text-center text-blue-600 text-3xl mb-4'>REGISTER</h2>
            <div className="mb-4">
            ...
            <button className='bg-blue-600 text-white px-4 py-2 font-medium hover:bg-blue-600-dark' onClick={handleSubmit}>Submit</button>
